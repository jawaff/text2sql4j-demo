...
class TranslatorTest(unittest.TestCase):
    ...
    def test_batch_translate(self):
        ...
        raw_input = [
            ...
            'Get stadiums nearby Washington DC. | concert_singer | stadium : stadium_id, location, name, capacity, highest, lowest, average | singer : singer_id, name, country, song_name, song_release_year, age, is_male | concert : concert_id, concert_name, theme, stadium_id, year | singer_in_concert : concert_id, singer_id'
        ]
        # Example output!
        #['concert_singer | select t2.concert_name from stadium as t1 join concert as t2 on t1.stadium_id = t2.stadium_id order by t1.capacity desc limit 1']
